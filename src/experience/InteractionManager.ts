...
export class InteractionManager {
  ...
  startDrag() {
    ...
    const intersects = this.raycaster.intersectObject(this.world.spring.mesh);
    ...
    if (intersects.length > 0) {
      ...
      for (const body of this.world.spring.bodies) {
      ...
      if (closestBody && closestBody.mass > 0) { // Don't drag the static base
